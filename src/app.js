      ...
      <MDBRow>
        <MDBCol>
          <MDBJumbotron style={{ padding: 0 }}>
            <MDBCol className="text-white text-center py-5 px-4 my-5" style={{ backgroundImage: `url(https://blog.spoongraphics.co.uk/wp-content/uploads/2013/retro-neon/9.jpg)` }}>
